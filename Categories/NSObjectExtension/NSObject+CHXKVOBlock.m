...
#import "NSObject+CHXKVOBlock.h"
#import <dispatch/dispatch.h>
#import <objc/runtime.h>
#import <libkern/OSAtomic.h>

static void * const AAPLObserverMapKey = @"com.foobar.blockObserverMap";
...
static dispatch_queue_t AAPLObserverMutationQueueCreatingIfNecessary() {
    ...
    dispatch_once(&queueCreationPredicate, ^{
        AAPLObserverMutationQueue = dispatch_queue_create("com.foobar.observerMutationQueue", 0);
    });
...
@implementation NSObject (CHXKVOBlock)

- (id)chx_addObserverForKeyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options withBlock:(AAPLBlockObserver)block {
